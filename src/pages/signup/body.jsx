        ...
        <div id="container">
            {modal ? (
                <form id="form" onSubmit={handleOnComplete}>
                    <input type="text" id="nameInput" placeholder="이름" onChange={onChangeName} />
                    <input type="text" id="idInput" placeholder="이메일" onChange={onChangeId} />
                    <input type="password" id="passwordInput" placeholder="비밀번호" onChange={onChangePassword} />
                    <input type="text" id="addressInput" placeholder="주소" onChange={onChangeAddress} />
                ...
                <form id="form" onSubmit={handleOnSubmit}>
                    ...
                    <p id="signup" onClick={() => { setModal(!modal) }}>회원가입</p>
                </form>
            )}
        </div>
    );
